...
echo date_format($departDate, 'Y-m-d');
	...
	$db->query("INSERT into `Booking` (`guest_id`, `booking_id`, `hotel_name`, `hotel_country`, `hotel_city`, `room_number`, `arrival`, `departure`) values ('ishaans', '10101', 'Fortuna Gate', 'India', 'Mumbai', 101, '2013-04-3', '2013-04-6' )");  
