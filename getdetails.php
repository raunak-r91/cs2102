       ...
       if($choice == 'hotel_city') {
        ...
        while($hotel = $db->fetch_assoc($hotel_query))
        {
            if($choice == 'hotel_city') {
                ...
                echo '<strong style="margin-left:20px"> Current Booking Dates </strong><input type="text" disabled class="input-medium" style="margin-left:70px" value="'.$arriveDate.'"></input> to <input type="text" disabled class="input-medium" style="margin-left:70px" value="'.$departDate .'"></input>';
            }
                ...
                echo '<strong style="margin-left:20px"> Current Type Of Room </strong><input type="text" disabled class="input-medium" style="margin-left:92px" value="'.stripslashes($room['roomtype']).'"></input>';
