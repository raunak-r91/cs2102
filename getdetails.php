       ...
       if($choice == 'hotel_city') {
        ...
        while($hotel = $db->fetch_assoc($hotel_query))
        {
            if($choice == 'hotel_city') {
                ...
                $room_query = $db->query("SELECT distinct r.type as roomtype FROM `Room` r, `Booking` b where booking_id = '$bookingID' and r.hotel_name = b.hotel_name and r.hotel_country = b.hotel_country and r.hotel_city = b.hotel_city");
